      ...
      `}>
        ...
        <Link to="/" className="flex items-center gap-2 sm:gap-3 pr-2 sm:pr-4 sm:border-r border-gray-200/70">
          <div className="relative">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-purple-600 via-indigo-600 to-blue-600 rounded-full flex items-center justify-center shadow-lg">
              <span className="text-white font-bold text-lg sm:text-xl">VP</span>
            </div>
          ...
          <span className="hidden lg:inline text-gray-800 font-bold text-xl sm:text-2xl bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">
            VP
          </span>
        </Link>
            ...
            return (
              <Link
                ...
                className={`
                  ...
                  ${isActive
                    ? 'bg-gradient-to-r from-purple-500 to-blue-500 text-white shadow-md shadow-purple-500/30 scale-100 sm:scale-105'
              ...
              >
                ...
                {isActive && (
                  <div className="absolute inset-0 bg-gradient-to-r from-purple-500/10 to-blue-500/10 rounded-full -z-10"></div>
                )}
              </Link>
            );
          })}
        ...
        <div className="pl-2 sm:pl-4 sm:border-l border-gray-200/70">
          ...
          >
            ...
            <span className="hidden lg:inline text-xs sm:text-sm font-medium">Instagram</span>
          </a>
        </div>
      </nav>
    </div>
